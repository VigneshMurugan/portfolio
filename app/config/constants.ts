...
export const SITE_AUTHOR = `Vignesh Murugan`;
export const SITE_DESCRIPTION = `The online portfolio of ${SITE_AUTHOR}, a Software Engineer!`;
export const SITE_EMAIL_ADDRESS = `vignesh328@gmail.com`;
...
export const SOCIAL_GITHUB = `https://github.com/VigneshMurugan`;
export const SOCIAL_LINKEDIN = `https://linkedin.com/in/VigneshMurugan`;
export const SOCIAL_TWITTER = `https://twitter.com/visumurugan`;
